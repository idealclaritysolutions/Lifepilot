...
const TIERS = [
  ...
  },
  {
    ...
    features: [
      ...
      'Weekly personalized check-ins from your coach',
      'Custom goal-setting with expert review',
      'Weekly progress reports curated by your coach',
      '300 AI messages/day + 75 web searches',
      'Unlimited journal, people, lists & habits',
      'AI-powered daily brief + Monday strategy session',
      'Priority support — 24hr response guaranteed',
    ],
    missing: [],
  },
]
  ...
  return (
    <div className="min-h-[100dvh] bg-[#FAF9F6]">
      ...
      <div className="px-4 py-4 space-y-4 max-w-lg mx-auto pb-32">
        ...
        {/* Guided plan coaching features */}
        {currentTier === 'enterprise' && (
          <div className="bg-white rounded-2xl border border-rose-100 p-5 shadow-sm space-y-4">
            <div className="flex items-center gap-2">
              <span className="text-xl">🎯</span>
              <h3 className="font-bold text-stone-800 text-base" style={{ fontFamily: "'Georgia', serif" }}>Your Coaching Hub</h3>
            </div>
            
            <a href="https://calendly.com/idealclarity" target="_blank" rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 w-full py-3.5 rounded-xl bg-gradient-to-r from-rose-500 to-pink-500 text-white font-semibold text-sm shadow-md hover:from-rose-600 hover:to-pink-600 transition-all">
              📅 Schedule Your Coaching Call
            </a>

            <div className="bg-rose-50/50 rounded-xl p-4">
              <p className="text-xs font-semibold text-rose-700 uppercase tracking-wider mb-2">What's included</p>
              <div className="space-y-2">
                <div className="flex items-start gap-2">
                  <span className="text-rose-400 mt-0.5 text-xs">●</span>
                  <p className="text-sm text-stone-700"><strong>Monthly 1-on-1 call</strong> — 30 min with your coach to review progress, set goals, and break through blocks</p>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-rose-400 mt-0.5 text-xs">●</span>
                  <p className="text-sm text-stone-700"><strong>Weekly check-ins</strong> — Your coach reviews your journal, habits, and tasks and sends personalized feedback</p>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-rose-400 mt-0.5 text-xs">●</span>
                  <p className="text-sm text-stone-700"><strong>Goal-setting with review</strong> — Custom goals set collaboratively with your coach, with weekly progress tracking</p>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-rose-400 mt-0.5 text-xs">●</span>
                  <p className="text-sm text-stone-700"><strong>Priority support</strong> — 24hr email response at support@getlifepilot.app</p>
                </div>
              </div>
            </div>
          </div>
