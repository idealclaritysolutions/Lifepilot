...
export function Settings({ state, notifications, locationHook, updateProfile, setUserLocation, onClose, onReset }: Props) {
    ...
    <div className="min-h-[100dvh] max-w-lg mx-auto">
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="bg-white rounded-2xl border border-stone-100 p-5 shadow-sm">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <button onClick={handleNotifications} disabled={state.profile.notificationsEnabled || enablingNotif}
                className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-colors ${
                  state.profile.notificationsEnabled
                    ? 'bg-emerald-50 text-emerald-600'
                    : 'bg-amber-100 text-amber-700 hover:bg-amber-200'
                }`}>
                {enablingNotif ? <Loader2 className="w-3 h-3 animate-spin" /> : state.profile.notificationsEnabled ? '✓ On' : 'Enable'}
              </button>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <button onClick={handleLocation} disabled={enablingLoc}
                ...
                {enablingLoc ? <Loader2 className="w-3 h-3 animate-spin" /> : state.profile.locationEnabled ? '✓ On' : 'Enable'}
              </button>
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-stone-700">Calendar Sync</p>
                  <p className="text-xs text-stone-600">Add tasks to Google Cal / Apple Cal</p>
                </div>
              </div>
              <span className="px-3 py-1.5 rounded-lg text-xs font-medium bg-emerald-50 text-emerald-600">✓ Ready</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-stone-100 p-5 shadow-sm">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm text-stone-700 font-medium">Data stays on your device</p>
                <p className="text-xs text-stone-600">Nothing is stored on our servers.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-stone-100 p-5 shadow-sm">
          ...
          <p className="text-xs text-stone-600 mt-2">Version 1.0 (v17)</p>
        </div>
